...
<div class="notebook">
  ...
  <iframe src="{{ site.url }}{{ site.baseurl }}/assets/jupyter/us_markets_animation.html" width="100%" height="600px" frameborder="0"></iframe>
  <iframe src="{{ site.url }}{{ site.baseurl }}/assets/jupyter/us_markets.html" width="100%" height="6000px" frameborder="0"></iframe>
  ...
  <!-- updating from page to assets -->
  <!-- <iframe src="assets/jupyter/us_markets_animation.html" width="100%" height="600px" frameborder="0"></iframe>
